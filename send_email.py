...
# Cria uma lista de dicionários contendo o e-mail e os diretórios correspondentes
destinatarios = []
for index, row in diretorios_df.iterrows():
    diretorio = row['DIRETORIES']
    email = row['EMAIL']
    destinatarios.append({'email': email, 'diretorio': diretorio})
...
for destinatario in destinatarios:
    ...
    # Cria o DataFrame a partir da lista de dicionários contendo o nome do arquivo e o diretório
    ...
    msg['Subject'] = 'Envio de Arquivos'

    # Adiciona o corpo da mensagem
    body = 'Segue em anexo os arquivos solicitados.'
